...
def main():
    sentences_corpus = (open('test_data.txt', "r")) # Input corpus (list of sentences as input where each sentence is a list of tokens. file should be in .pkl format).
    domain_vocab_file = 'domain_words.txt' # domain-specific vocabulary. file should be in .pkl format
